---
description: "COD-1584: /codello:spawn stages the prompt in the session scratchpad and passes it with --prompt-file, never through $TMPDIR, /tmp, or a $(cat) substitution."
